...
3. **Read the in-scope files**: The repo is small. Read these files for full context:
   ...
   - `prepare.sh` — downloads MATH-500 dataset. Do not modify.
...
Each experiment runs on the test set (50 problems). You launch it simply as: `bash eval/eval.sh`.
...
**The goal is simple: get the highest accuracy on MATH-500 test set.** Accuracy = fraction of problems where your solver's extracted answer matches the ground truth. The metric is a number between 0.0 and 1.0.
